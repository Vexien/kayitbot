...
module.exports.run = async (client, message, args) => {
  if (
    !message.member.roles.cache.some(r =>
      ["805588624615145473"].includes(r.id)
    ) &&
  ...
  if (!kullanıcı) {
    ...
    const kayıtlar2 = new Discord.MessageEmbed()
      ...
      .setDescription(`<a:ahypebrave:783372451014377562> • Toplam Kayıtlar:  \`${kayıtlar}\`
    <a:ahypebrave:783372451014377562> • Toplam Erkek Kayıtların: \`${erkek}\`
    <a:ahypebrave:783372451014377562> • Toplam Kadın Kayıtların: \`${kadın}\`
    `);
  ...
  if (kullanıcı) {
    ...
    const kayıtlar3 = new Discord.MessageEmbed()
      ...
      .setDescription(`<a:ahypebrave:783372451014377562> • Toplam Kayıtların: \`${kayıtlar1}\`
<a:ahypebrave:783372451014377562> • Toplam Erkek Kayıtların: \`${erkek1}\`
<a:ahypebrave:783372451014377562> • Toplam Kadın Kayıtların: \`${kadin1}\`
`);
...
exports.conf = {
  enabled: true,
  guildOnly: true,
  aliases: ["stat", "kayıtlar", "kayıt-kontrol", "kayıtbilgi"],
  permLvl: 0
};
